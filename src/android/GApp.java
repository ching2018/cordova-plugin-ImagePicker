...
public class GApp extends Application {
    ...
    public static DisplayImageOptions imageLoaderOptions = new DisplayImageOptions.Builder()//
            ...
            .showImageForEmptyUri((new FakeR(this)).getId("mipmap", "default_image"))       //设置图片Uri为空或是错误的时候显示的图片
            .showImageOnFail((new FakeR(this)).getId("mipmap", "default_image"))            //设置图片加载/解码过程中错误时候显示的图片
    ...
    public static ImageOptions xUtilsOptions = new ImageOptions.Builder()//
            ...
            .setLoadingDrawableId((new FakeR(this)).getId("mipmap", "default_image"))       //下载中显示的图片
            .setFailureDrawableId((new FakeR(this)).getId("mipmap", "default_image"))       //下载失败显示的图片
