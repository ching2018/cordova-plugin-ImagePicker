...
import com.holdskill.imagepicker.view.ViewPagerFixed;
...
public abstract class ImagePreviewBaseActivity extends ImageBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(packagenameR.getId("layout", "activity_image_preview"));
        ...
        //初始化控件
        content = findViewById(packagenameR.getId("id", "content"));

        //因为状态栏透明后，布局整体会上移，所以给头部加上状态栏的margin值，保证头部不会被覆盖
        topBar = findViewById(packagenameR.getId("id", "top_bar"));
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) topBar.getLayoutParams();
            params.topMargin = Utils.getStatusHeight(this);
            topBar.setLayoutParams(params);
        }
        topBar.findViewById(packagenameR.getId("id", "btn_ok")).setVisibility(View.GONE);
        topBar.findViewById(packagenameR.getId("id", "btn_back")).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mTitleCount = (TextView) findViewById(packagenameR.getId("id", "tv_des"));

        mViewPager = (ViewPagerFixed) findViewById(packagenameR.getId("id", "viewpager"));
